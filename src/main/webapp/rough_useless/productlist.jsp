...
<head>
    ...
    <link rel="stylesheet" href="swiper/swiper_bundle_min.css">
                ...
                <div class="container flex flex-wrap items-center justify-between w-full px-6 py-3 mx-auto mt-0">
                    ...
                    <div class="flex order-1 md:order-2">
                        <a class="flex items-center text-xl font-bold tracking-wide no-underline text-main-blue text-maintheme gap-x-2 hover:no-underline "
                            href="#">
                            <img width="24" height="24" src="image_resources/logo.png" alt="" srcset="">
                            FIXMIA
                        </a>
                    </div>
            ...
            <div id="default-carousel" class="relative w-full" data-carousel="static">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div class="hidden duration-[1s] ease-in-out" data-carousel-item>
                        <img src="image_resources/constructors.jpg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-[1s] ease-in-out" data-carousel-item>
                        <img src="image_resources/carpentors.jpg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        <!-- <img src="/docs/images/carousel/carousel-2.svg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."> -->
                    </div>
                    <!-- Item 3 -->
                    <div class="hidden duration-[1s] ease-in-out" data-carousel-item>
                        <img src="image_resources/electrician.jpeg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        <!-- <img src="/docs/images/carousel/carousel-3.svg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."> -->
                    </div>
                    <!-- Item 4 -->
                    <div class="hidden duration-[1s] ease-in-out" data-carousel-item>
                        <img src="image_resources/plumbers.jpeg"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        <!-- <img src="/docs/images/carousel/carousel-4.svg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."> -->
                    </div>
                    <!-- Item 5 -->
                    <div class="hidden duration-[1s] ease-in-out" data-carousel-item>
                        <img src="image_resources/computer_worker.png"
                            class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                </div>
                <!-- Slider indicators -->
...
<%--                </div>--%>
                ...
                <div class="pb-6 col-span-full md:pb-0 md:col-span-6">
                    <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 md:justify-start">
                        <div class="flex items-center justify-center w-12 h-12 rounded-full ">
                          <img src="image_resources/logo.png" alt="" srcset="">
                        </div>
    ...
    <!-- Swiper JS -->
    <script src="swiper/swiper_bundle.js"></script>
