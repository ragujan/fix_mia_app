    ...
    <div class="flex flex-col">
        ...
        <nav id="header" class="z-30 w-full py-1 sm:hidden md:flex">
            <div class="container flex flex-wrap items-center justify-between w-full px-6 py-3 mx-auto mt-0">
                ...
                <div class="order-3 hidden w-full font-semibold text-gray-600 md:flex md:items-center md:w-auto md:order-1"
                     id="menu">
                    <nav>
                        <ul class="items-center justify-between pt-4 text-base md:flex md:pt-0">
                            ...
                            <li>
                                <a class="hidden px-4 py-2 no-underline md:inline-block hover:text-black hover:underline"
                                   href="#">Discover</a></li>
                            <li>
                                <a class="hidden px-4 py-2 no-underline md:inline-block hover:text-black hover:underline"
                                   href="#">About</a></li>
        ...
        <div class="grid justify-center pt-6 lg:justify-between">
            ...
            <div class="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                <a rel="noopener noreferrer" href="#" title="Email"
                   class="flex items-center justify-center w-10 h-10 bg-white rounded-full dark:text-gray-900">
